...
class Tdiff:
    ...
    def load(
        ...
        """
        mdata = MuData({feature_key: input, "milo": AnnData(),"pseudobulk":AnnData()})
    ...
    def make_da_cpm(
        ...
        try:
            ...
            print(
                "[bold red]milo_mdata should be a MuData object with three slots:"
                " feature_key and 'milo' - please make_pseudobulk_parallel() first"
            )
            raise
        

        indexCell=milo.var["index_cell"]
    ...
    def da_expression(
        ...
        if shuffle:
            ...
            milo.var.index=milo.var["index_cell"]
            ...
            milo.varm[var1]=self.mergeVar(varDf,group1.T)
            milo.varm[var2]=self.mergeVar(varDf,group2.T)
    ...
    def permute_point_gene(self,
        ...
        try:
            ...
            print(
                "milo_mdata should be a MuData object with three slots: feature_key and 'milo' and 'pseudobulk' - please run milopy.count_nhoods(adata) first"
            )
            raise
        varTable=sample_adata.var
    ...
    def test_gene_binom(self,
        ...
        try:
            ...
            print(
                "milo_mdata should be a MuData object with three slots: feature_key and 'milo' - please run milopy.count_nhoods(adata) first"
            )
            raise
        times=pseudobulk.uns["shuffle_times"]
    ...
    def permute_point_cpm(self,
        ...
        milo.uns["cpm_dict"]=permute_point_dict
    ...
    def permute_point_cpm_parallel(self,mdata, mode:str="DE",
        ...
        if mode == "DA":
            try:
                ...
                print("milo_mdata should be a MuData object with three slots: feature_key and 'pseudobulk' - please run milopy.count_nhoods(adata) first")
                raise
        else: 
            try:
                milo = mdata["milo"]
