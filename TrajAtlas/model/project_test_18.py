...
def label_transfer(adata):
    ...
    adata_sub.obs[['pred_lineage_lepr', 'pred_lineage_msc', 'pred_lineage_chondro',"pred_lineage_fibro"]]=adata_sub.obs[['pred_lineage_lepr', 'pred_lineage_msc', 'pred_lineage_chondro',"pred_lineage_fibro"]].astype("bool")
    return(adata)
...
def substractLineageAdata(adata, lineage: list or None = ["Fibro", "Lepr", "MSC", "Chondro"]):
    lineageDict = {
        "Fibro": "pred_lineage_fibro",
        "Lepr": "pred_lineage_lepr",
        "MSC": "pred_lineage_msc",
        "Chondro": "pred_lineage_chondro"
    }
    if not isinstance(lineage, list):
        raise TypeError("Lineage argument must contain only the valid lineages: 'Fibro', 'Lepr', 'MSC', 'Chondro'.")
    if lineage is None:
        lineage = ["Fibro", "Lepr", "MSC", "Chondro"]
